...
player.bounceOff(boundaryL);
player.bounceOff(boundaryR);
player.bounceOff(boundaryT);
player.bounceOff(boundaryB);

  drawSprites();
}
function CreateMap(){

boundaryL = createSprite(0,200,1,400);
boundaryR = createSprite(400,200,1,400);
boundaryT = createSprite(200,0,400,1);
boundaryB = createSprite(200,400,400,1);
